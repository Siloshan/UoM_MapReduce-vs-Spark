...
#### This analyze is for time taken to exacute queries. For that, we have used hive which uses hiveQL statement which runs over MapReduce and spark which uses Spark-SQL which runs over spark framework. 
